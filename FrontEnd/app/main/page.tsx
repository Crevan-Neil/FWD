...
export function BlockPage() {
  ...
  <DialogContent className="sm:max-w-[425px]">
    ...
    <Button
      variant="outline"
      onClick={() => window.location.href = 'https://aistudio.google.com/prompts/1R4vdObrkD5wAh59EQeow8hoc5bqTbZxd'} // navigate to the provided URL
      className="bg-primary/10 hover:bg-primary/20 transition-colors duration-300 mt-4"
    >
      Chat with ai
    </Button>
  </DialogContent>
